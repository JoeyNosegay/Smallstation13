/datum/job/hos
	...
	total_positions = 3
	spawn_positions = 3
	supervisors = "the Head Lead, and the authority of your council."
...
/datum/job/warden
	...
	economic_modifier = 5
	access = list(access_security, access_brig, access_external_airlocks)
	minimal_access = list(access_security, access_brig, access_external_airlocks)
...
/datum/job/officer
	...
	total_positions = 4
	spawn_positions = 4
	supervisors = "the expedition leads, the warden."
	selection_color = "#ffeeee"
	alt_titles = list("Public Safety Officer")
	economic_modifier = 4
	access = list(access_security,access_maint_tunnels,)
	minimal_access = list(access_security,access_maint_tunnels,)
